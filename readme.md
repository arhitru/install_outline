...
Понадобится любая версия OpenWRT (проверялось на 19.07, 21.02, 22.03, 23.05-rc1 и 24.10.5) и установленные пакеты kmod-tun и ip-full, а так же настроенный сервер Outline (shadowsocks).

Рекомендую роутер не меньше чем с 128 Мб ОЗУ.
